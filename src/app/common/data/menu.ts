...
export const verticalMenuItems = [ 
    ...
    new Menu (2, 'Master Reports', null, null, 'account_tree', null, true, 0), 
    // new Menu (201, 'Account Details', '/ui/buttons', null, 'keyboard', null, false, 2),  
    new Menu (201, 'Account Tax List', '/master/account-tax-list', null, 'account_circle', null, false, 2),
    new Menu (202, 'Exchange Tax List', '/master/exchange-tax-list', null, 'currency_exchange', null, false, 2),
    new Menu (203, 'Brokerage Setup List', '/master/brokerage-setup-list', null, 'payments', null, false, 2),
    new Menu (204, 'Item Master List', '/master/item-master', null, 'category', null, false, 2),
    new Menu (205, 'Sauda Master List', '/master/sauda-master', null, 'web_stories', null, false, 2),
    new Menu (206, 'Script Master List', '/master/script-master', null, 'article', null, false, 2),
    new Menu (207, 'Contract Master List', '/master/contract-master', null, 'receipt_long', null, false, 2),
    new Menu (213, 'Account List', '/master/account-list', null, 'menu', null, false, 2),

    // new Menu (3, 'Contract Report', null, null, 'supervisor_account', null, true, 0), 
    // new Menu (202, 'Contract Register', '/ui/buttons', null, 'keyboard', null, false, 3),  

    new Menu (3, 'Account Statement', null, null, 'supervisor_account', null, true, 0), 
    // new Menu (203, 'Account Statemnet Summary', '/ui/buttons', null, 'keyboard', null, false, 4),  
    new Menu (208, 'Bill Summary with sharing', '/acc-stat/bill-sum-sharing', null, 'keyboard', null, false, 3),  

    new Menu (4, 'Reports', null, null, 'receipt_long', null, true, 0), 
    new Menu (209, 'Trail Balance', '/reports/trail-balance', null, 'text_snippet', null, false, 4),
    new Menu (210, 'General Ledger', '/reports/general-ledger', null, 'receipt_long', null, false, 4),
    new Menu (211, 'Standing Statement', '/reports/standing-statement', null, 'receipt_long', null, false, 4),
    new Menu (212, 'Live Bill Summary', '/reports/live-bill-summary', null, 'receipt_long', null, false, 4)

    // new Menu (5, 'Financial Reports', null, null, 'supervisor_account', null, true, 0), 
    // new Menu (205, 'voucher list', '/ui/buttons', null, 'keyboard', null, false, 5),  
