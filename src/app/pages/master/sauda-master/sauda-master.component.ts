...
@Component({
  selector: 'app-sauda-master',
  imports: [AgGridModule, AgGridAngular, MatInputModule, MatIconModule, CommonModule, MatGridListModule, FlexLayoutModule],
  templateUrl: './sauda-master.component.html',
  styleUrl: './sauda-master.component.scss'
})
export class SaudaMasterComponent implements OnInit {
  gridAPI: any
  SaudaMasterList: any
  ...
  columnDefs = [
    ...
    { headerName: 'Tradeable Lot', field: 'tradeablelot', filter: true, sorting: true, resizable: true },           
    ...
    { headerName: 'Sauda Id', field: 'saudaid', filter: true, sorting: true, resizable: true },
    ...
    { headerName: 'Trading Date', field: 'tradingdate', filter: true, sorting: true, resizable: true },
    { headerName: 'Sadd Time', field: 'saddtime', filter: true, sorting: true, resizable: true },
  ];
  ...
  onBtnExport(): void {
    const params =
    {
      fileName:'Sauda Master List',
      columnKeys: ['compCode', 'saudacode', 'saudaname', 'itemcode', 'maturity', 'tradeablelot', 'broklot', 'insttype', 'opttype', 'strikeprice', 'excode', 'refLot', 'saudaid', 'exid', 'itemid', 'tradingdate', 'saddtime']
      , customHeader:'Sauda Master List'
    }
  ...
  downloadAsPDF() {
    const csvData = this.gridAPI.getDataAsCsv({
      columnKeys: [
        'compCode', 'saudacode', 'saudaname', 'itemcode', 'maturity', 'tradeablelot', 'broklot', 'insttype', 'opttype', 'strikeprice', 'excode', 'refLot', 'saudaid', 'exid', 'itemid', 'tradingdate', 'saddtime'
      ],
    ...
    const mainHeader = "Sauda Master List";
    ...
    autoTable(doc, {
      head: [['compCode', 'saudacode', 'saudaname', 'itemcode', 'maturity', 'tradeablelot', 'broklot', 'insttype', 'opttype', 'strikeprice', 'excode', 'refLot', 'saudaid', 'exid', 'itemid', 'tradingdate', 'saddtime']],
  ...
  initalApiCalls() {
    this._masterService.getSaudaMasterList().subscribe((results) => {
      debugger
      if (results.isSuccess) {
        this.SaudaMasterList = results.data;
      }
