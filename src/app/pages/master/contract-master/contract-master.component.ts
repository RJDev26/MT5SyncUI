...
@Component({
  ...
  styleUrl: './contract-master.component.scss'
})
export class contractMasterComponent implements OnInit {
  gridAPI: any
  contractMasterList: any
  ...
  columnDefs = [
    ...
    { headerName: 'Isin', field: 'isin', filter: true, sorting: true, resizable: true },
    { headerName: 'lseries', field: 'lseries', filter: true, sorting: true, resizable: true },           
    { headerName: 'Cadd Time', field: 'caddtime', filter: true, sorting: true, resizable: true },
    { headerName: 'Contract Id', field: 'contractId', filter: true, sorting: true, resizable: true },
  ];
  ...
  onBtnExport(): void {
    const params =
    {
      fileName:'Contract Master List',
      columnKeys: ['excode', 'itemcode', 'itemname', 'lot', 'isin', 'lseries', 'caddtime', 'contractId']
      , customHeader:'Contract Master List'
    }
  ...
  downloadAsPDF() {
    const csvData = this.gridAPI.getDataAsCsv({
      columnKeys: [
        'excode', 'itemcode', 'itemname', 'lot', 'isin', 'lseries', 'caddtime', 'contractId'
      ],
    ...
    const mainHeader = "Contract Master List";
    ...
    autoTable(doc, {
      head: [['excode', 'itemcode', 'itemname', 'lot', 'isin', 'lseries', 'caddtime', 'contractId']],
    ...
    doc.save("ContractMasterList.pdf");
  }
  ...
  initalApiCalls() {
    this._masterService.getContractMasterList().subscribe((results) => {
      debugger
      if (results.isSuccess) {
        this.contractMasterList = results.data;
      }
